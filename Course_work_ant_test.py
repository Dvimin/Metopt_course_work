    ...
    def run(self):
        ...
        for iteration in range(self.n_iterations):
            ...
            for ant_index, ant in enumerate(ants):
                ...
                print(f" Муравей {ant_index + 1} завершил маршрут с общей стоимостью {cost}")
        ...
        print(f"Лучший маршрут после {self.n_iterations} итераций: {best_path} с стоимостью {best_cost}")
